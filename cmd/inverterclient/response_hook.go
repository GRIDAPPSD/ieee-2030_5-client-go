...
// method set. The interface intentionally matches
// inverter.ResponsePoster so a *SEP2Client (or any fake) flows through
// PostResponseWithRetry without an adapter.
